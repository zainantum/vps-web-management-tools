        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tables /</span> List</h4>
              <div class="row">

                <!-- Form controls -->
                <div class="col-md-12">
                  <div class="card mb-4">
                    <h5 class="card-header">CRUD VPS MATI</h5>
                    <div class="card-body">
                    <div class="alert alert-secondary mt-4" role="alert">
                      Format penambahan ip baru: ipvps;username-telegram;email/project-name;platform<br>
                      Contoh:<br>
                      GCP: 123.45.6.789;@imrnmln;project-trium;gcp<br>
                      DO: 45.78.111.09;@imrnmln;beli1;do
                    </div>
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" id="action" name="action" value="addIpSection">
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="inputState" class="form-select" onchange="cekIpLama(this.value)">
                                ...
                                <div class="col-md-6" id="addIpSection">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1" class="form-label">Masukkan IP Baru</label>
                                ...
                                <div id="editIpSection" style="display: none">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1" class="form-label">IP Lama</label>
                                            <input class="form-control" id="ipLama" name="ipLamaEdit" placeholder="Enter ip">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1" class="form-label">IP Baru</label>
                                ...
                                <div class="col-md-6" id="deleteIpSection" style="display: none">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1" class="form-label">Masukkan IP yg mau dihapus</label>
              ...
              <!-- Responsive Table -->
              <div class="card">
                <h5 class="card-header">Daftar IP Mati</h5>
                <div class="table-responsive text-nowrap">
                  <table id='empTable' class="table dataTable table-dark">
                    <thead>
