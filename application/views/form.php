        ...
        <div class="layout-page">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" href="exorde/profile">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms </h4>
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="card mb-4">
                    <h5 class="card-header">CRUD + Run Command VPS</h5>
                    <div class="card-body">
                    <form class="form-horizontal" id="frmIsianVps" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                      <div class="row">
                        ...
                        <input type="hidden" id="action2" name="action2" value="addAkunSection">
                          <div class="mb-3">
                            <label for="exampleFormControlSelect1" class="form-label">Pilih tindakan....</label>
                            <select class="form-select" aria-label="Default select example" id="cmbMaster" name="cmbMaster">
                            <option>Pilih...</option>
                                <option value="addProjectSection">Tambahkan projek dan credential</option>
                                <option value="addPemSection">Tambahkan file .pem</option>
                                <option value="actionProjectSection">Akses vps google cloud (buat, hapus, start, stop dan run command)</option>
                                <option value="vpsdo">Akses vps digital ocean</option>
                            </select>
                          </div>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-body text-center d-block">
                          <div id='loader'>
                            <img src='exorde/assets/loader.gif' width='150px' height='150px'>
                          </div>
                      </div>
                    </div>
                  </div>
