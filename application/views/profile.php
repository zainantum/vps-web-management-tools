        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="/exorde" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Arbyter</span>
            </a>
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block" style="color: #6c757d!important;"><?php echo $this->ci->session->userdata('username') ?></span>
                    ...
                    <li>
                      <a class="dropdown-item" href="#">
                        ...
                        <span class="align-middle" style="color: #6c757d!important;">My Profile</span>
                      </a>
                    </li>
                    <li>
                      <div class="dropdown-divider"></div>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row">
                ...
                <!-- Form controls -->
                <div class="card mb-3">
                  <h5 class="card-header">Daftar Project GCP Anda</h5>
                    <div class="card-body">
                      <h6 class="card-text mt-2 mb-2">Fitur hapus di sini hanya akan menghapus project dari database dan menghapus file credential terkait. Untuk menghapus vps silahkan menggunakan fitur yg sudah disediakan. IP VPS dengan nama project yg sesuai akan dihapus juga dari watch list dan database</h6>
                      <div class="table-responsive text-nowrap">
                      <table id='listProject' class="table dataTable table-dark">
                          <thead>
                ...
                <div class="card mb-3">
                    <div class="card-header">Daftar IP Anda</div>
                    <div class="card-body">
                      <h6 class="card-text mt-2 mb-2">Fitur hapus di sini hanya akan menghapus ip dari watch list. Untuk menghapus vps silahkan menggunakan fitur yg sudah disediakan.</h6>
                      <div class="table-responsive text-nowrap">
                      <table id='listTable' class="table dataTable table-dark">
                          <thead>
                          <tr class="text-nowrap">
                              <th>IP</th>
                              <th>Telegram</th>
