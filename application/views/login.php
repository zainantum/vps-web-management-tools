        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <p class="mb-4">Sebelum ngakses ada baiknya login dulu dong pun</p>

              <form id="frmIsianLogin" class="mb-3" method="POST">
                <div class="mb-3">
                  <label for="email" class="form-label">Ini username</label>
                  <input
                    type="text"
                    class="form-control"
                    id="username"
                ...
                <div class="mb-3 form-password-toggle">
                  <div class="d-flex justify-content-between">
                    <label class="form-label" for="password">Yang ini password</label>
                    <!-- <a href="auth-forgot-password-basic.html">
                      <small>Lupa Password? mosok lali blok</small>
                    </a> -->
                  </div>
                ...
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100" type="button" onclick="doLogin()">Masokkk</button>
                </div>
              </form>

              <p class="text-center">
                <span>Belum punya akun kah maniezzz?</span>
                <a href="http://167.86.127.69/exorde/register">
                  <span>Gass buat dulu</span>
                </a>
              </p>
            </div>
          </div>
