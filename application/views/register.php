...
>
  <head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="http://167.86.127.69/exorde/assets/vendor/css/pages/page-auth.css" />
    <!-- Helpers -->
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Arbyter</span>
                </a>
              </div>
              <!-- /Logo -->
              <!-- <h4 class="mb-2">Yukk daftar dulu biar lebih aman vpsnya</h4> -->
              <p class="mb-4">Yukk daftar dulu biar lebih aman vpsnya</p>

              <form id="frmIsianRegister" class="mb-3" method="POST">
                <div class="mb-3">
                ...
                <div class="mb-3">
                  <label for="email" class="form-label">Telegram Username</label>
                  <input type="text" class="form-control" id="usernameTg" name="usernameTg" placeholder="Enter your telegram username" />
                </div>
                ...
                <button class="btn btn-primary d-grid w-100" type="button" onclick="doRegister()">Gasss daftar</button>
              </form>

              <p class="text-center">
                <span>Udah punya akun? ngapain ke sini</span>
                <a href="http://167.86.127.69/exorde/login">
                  <span>Ayok login</span>
                </a>
              </p>
            </div>
          </div>
